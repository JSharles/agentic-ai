...
def overlap_importance():
    text = (
        "The quick brown fox jumps over the lazy dog. salut je m appelle jeancharles , et je suis vis a marsseille depuis 2-3 an s. C est super il fait beau. ca a toujours ete un endroit dans lequel j ai souhite vivre depuis mapluys tendre enfance. je crois que les souvenir et les emotion qu ils portent joue un role essentiel dans les choix que nous faisons lors de notre vie d adulte , dans la cretion et l expression de nos souhait et objectif de vie. "
        * 10
    )  # Repeated text
    ...
    # with overlap
    with_overlap = RecursiveCharacterTextSplitter(chunk_size=50, chunk_overlap=30)
...
def document_splitter():
    ...
    loader = PyPDFLoader("./docs/product-engineer-checklist.pdf")
    docs = loader.load()

"""
Understanding Chains in LangChains V.1
...
def demo_basic_chain():
    ...
    result = chain.invoke(
        {"text": "LangChain is a framework for developing applications powered by AI"}
    )
...
def demo_parallel_chain():
    ...
    text = """The new AI features are absolutely incredible! Users are loving the faster response times and improved accuracy. However, some have noted that the pricing could be more competitve. Overall, the product launch has been a massive success with record-breaking adoption rates."""
...
def demo_chain_branching():
    """A cahin that demonstrates branching functionnality."""
    ...
    general_prompt = ChatPromptTemplate.from_template(
        "You are helpful assistant. Answer: {input}"
    )
